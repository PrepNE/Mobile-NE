...
const CreateExpense = () => {
    ...
    const handleCreateExpense = async () => {
        ...
        if (formData.description.length > maxDescriptionLength) {
            toast.show(`Description cannot be longer than ${maxDescriptionLength} characters`, {
                type: "danger",
            });
            return;
        }
                ...
                <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
                    ...
                    <View className="px-4 pt-4 pb-3 border-b border-gray-200 bg-white shadow-sm flex-row justify-between items-center">
                        <View className="flex-row items-center">
                            ...
                            <Text className="text-lg font-semibold ml-2 text-gray-800">New Expense</Text>
                        </View>
                    </View>
                        ...
                        <View className="bg-white p-5 rounded-2xl shadow-md border border-gray-100">
                            <View className="mb-6">
                                <View className="flex-row justify-between items-center mb-1">
                                    <Text
                                        className={`text-xs font-medium ${nameCharCount > maxNameLength
                                            ? "text-red-500"
                            ...
                            <View className="mb-2">
                                <View className="flex-row justify-between items-center mb-1">
                                    <Text
                                        className={`text-xs font-medium ${descriptionCharCount > maxDescriptionLength
                                            ? "text-red-500"
